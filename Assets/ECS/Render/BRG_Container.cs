...
public unsafe class BRG_Container
{
    ...
    public int MaxInstanceCount => m_maxInstances;
    public bool isInitialized => m_initialized;

    public bool Init(Mesh mesh, Material mat, int maxInstances, bool castShadows, bool alsoSettingColors=false)
    {
        _useColor = alsoSettingColors;
       return Init(mesh, mat, maxInstances, alsoSettingColors ? 112 : 96, castShadows);
    }
